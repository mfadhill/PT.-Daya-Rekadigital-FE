...
import { allCustomer } from "../../store/Async/allCustomerAsync";
...
const CustomerManagement = () => {
  ...
  const handleSearch = async () => {
    try {
      setLoading(true);
      console.log(name);
      if (name === "") await dispatch(allCustomer());
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        navigate("/customer");
        if (response.status === 200 || response.status === 201) {
          setNotification("Successfully added customer!");
          setTimeout(() => {
            setNotification("");
            setShowModal(false);
            navigate("/customer");
          ...
          setNotification("Failed to add customer.");
        }
      } else {
  ...
  if (loading) {
    return (
      <ReactLoading type={"spin"} color={"grey"} height={667} width={375} />
    );
  }

  return (
    <div className="pl-4 mt-2">
      <h1 className="text-2xl font-bold non-italic">Customer</h1>
      ...
      <div className="flex mt-6">
        <div className="bg-gray-200 p-4 w-full">
          <div className="bg-blue-500 p-2 h-40 overflow-hidden">
            <div className="flex">
              <div className="flex-1 basis-1/2">
                <h1 className="text-xl non-italic text-white">Customer</h1>
                <span className="text-white text-xs">
                  On this menu you will be able to create, edit, and also <br />
          ...
          {/* button */}
          <div className="flex items-center mt-3 space-x-2 rounded-xl">
            <button
            ...
            <input
              type="text"
              placeholder="Search..."
              className="border border-gray-300 rounded-xl px-4 py-2 w-auto max-w-xs"
            />
            <button className="bg-green-500 p-2 text-white rounded-xl flex items-center justify-center">
              Submit
            </button>
          </div>
          {notification && (
            <div className="fixed bg-green-500 text-white p-4 rounded-xl shadow-lg">
              {notification}
            </div>
          )}
          {/* modal */}
              ...
              <div className="bg-white rounded-xl p-6 w-96 shadow-xl">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      type="text" // Changed to text to accept any phone number format
                      name="phone"
                  ...
                  <div className="flex justify-end space-x-2">
                    <button
                      type="button"
                      className="bg-gray-500 p-2 text-white rounded-xl"
          ...
          <div className="min-w-full inline-block align-middle mt-3">
                    ...
                    >
                      ...
                      <td className=" p-5 ">
                        <div className="flex items-center gap-1">
                          <button className="p-2  rounded-xl group transition-all duration-500 bg-gray-200 flex item-center">
                            Detail
                          </button>
